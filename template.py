...
def compare_models(prompt: str) -> dict:
    ...
    # Estimate cost: words → tokens → cost
    gpt4o_cost_estimate = (
        (len(gpt4o_response.split()) / 0.75) / 1000 * COST_PER_1K_OUTPUT_TOKENS[OPENAI_MODEL]
    )
...
def streaming_chatbot() -> None:
    ...
    while True:
        ...
        # Keep only the last 3 turns (each turn = 1 user + 1 assistant message pair)
